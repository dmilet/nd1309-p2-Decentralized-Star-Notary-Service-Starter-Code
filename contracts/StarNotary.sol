...
contract StarNotary is ERC721 {
    ...
    constructor(string memory _name, string memory _symbol) ERC721(_name, _symbol)  { 
        // no class data to initialize except from ERC721
    }
    ...
    function approveRecipient(uint256 _tokenId, address _buyer) public {
        require(ownerOf(_tokenId) == msg.sender, "The requestor does not own the star");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(ownerOf(_tokenId) == msg.sender, "You can't exchange stars you don't own");
